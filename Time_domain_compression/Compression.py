...
for i in range(0, 20):
    img_path = rf"/Time_domain_compression/m_20_512_fft/image_{i}png"
    mask_path = rf"/Time_domain_compression/mask/mask_{i}.bmp"
...
compressed_image = np.sum(images, axis=0)

# compressed_image *= 255
compressed_image = compressed_image.astype(np.float64)

# save the compressed image
cv2.imwrite(r"/Time_domain_compression/compressed_image.png", compressed_image)
...
# save as .mat file
output_path = r'/Time_domain_compression/meas.mat'
