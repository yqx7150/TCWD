...
def test_for_real(model):
    meas = scio.loadmat(rf"/Time_domain_unfolding/meas.mat")['meas']
#    meas = scio.loadmat(r'C:\Users\22591\Desktop\DMDTC\Code\Time_domain_unfolding\meas.mat')['meas']
    ...
    for i in range(1):#meas.shape[0]
        for j in range(20):
            cv2.imwrite(r'/Time_domain_unfolding/recon/{}_{}.png'.format('result', j + 20 * i),out_save1.detach().cpu().numpy()[i, j, :, :] * 255)
...
if __name__ == '__main__':
    ...
    model_parameter = torch.load(r'/Time_domain_unfolding/model/base/model_state_epoch_1_it_4950.pth')
